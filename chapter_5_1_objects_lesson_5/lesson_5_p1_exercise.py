...
mr_burdell = Person(name="Mr. Burdell", age=53)
mrs_burdell = Person(name="Mrs. Burdell", age=53)
george_p = Person(name="George P. Burdell", age=25, father=mr_burdell, mother=mrs_burdell)
