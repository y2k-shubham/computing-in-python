...
def search_for_string(list_of_string, search_string):
    filtered_enumeration = filter(lambda tup: tup[1] == search_string, enumerate(list_of_string))
    filtered_indices = map(lambda tup: tup[0], filtered_enumeration)
